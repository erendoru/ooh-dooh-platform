...
function Charts() {
  return (
    <div className="chart-wrapper mx-auto flex max-w-6xl flex-col my-28 flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8">
      ...
      <div className="grid w-full flex-1 gap-6 lg:max-w-[20rem]">
        ...
        <Card className="max-w-xs" x-chunk="charts-01-chunk-3">
          <CardHeader className="p-4 pb-0">
            <CardTitle></CardTitle>
            <CardDescription>
              Son kampanyadan alınan veri farkları.
            </CardDescription>
          </CardHeader>
      ...
      <div className="grid w-full flex-1 gap-6">
        ...
        <Card className="max-w-xs" x-chunk="charts-01-chunk-6">
          <CardHeader className="p-4 pb-0">
            <CardTitle>Active Pano</CardTitle>
            <CardDescription>Getting impression</CardDescription>
          </CardHeader>
